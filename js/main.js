...
function initContactInteractions() {
    ...
    emailItems.forEach(item => {
        if (item.textContent.includes('chitaguppeshubham007@gmail.com')) {
            item.style.cursor = 'pointer';
            item.addEventListener('click', copyEmail);
...
function downloadCV() {
    ...
    link.href = 'assets/documents/Shubham_CV.pdf';
...
// Copy email to clipboard
function copyEmail() {
    const email = 'chitaguppeshubham007@gmail.com';
...
// Utility functions
const utils = {
    // Debounce function for search or input handling
